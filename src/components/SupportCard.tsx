    ...
    <section className="w-full max-w-4xl mx-auto px-4 mb-12">
      <div className="rounded-xl border border-slate-800 bg-[#0f0f0f] p-6">
        <div className="flex items-start gap-4">
          <div className="shrink-0 w-10 h-10 rounded-full bg-[#128C7E]/15 border border-[#128C7E]/30 flex items-center justify-center">
          ...
          <div className="flex-1 min-w-0">
            ...
            <a
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-sm font-medium border border-[#128C7E]/40 text-[#25D366] hover:border-[#128C7E]/70 hover:text-[#4ade80] transition-all duration-200"
            >
